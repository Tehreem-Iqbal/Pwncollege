...
char flags[7] = {0};
void interpret_cmp(unsigned char arg1, unsigned char arg2){ // Compare reg1 and reg2 value and set the flag register accordingly
...
int interpret_jmp(unsigned char flag, unsigned char reg){ //Jump to the address in reg, depending on flag value
    printf(" ---------------------------------------------------------------------------------------------------------\n");
